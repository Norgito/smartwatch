      ...
      <AppBar sx={{ backgroundColor: '#2c2c2c' }}>
        <Toolbar>
          ...
          <Tabs textColor="white"  sx={{marginLeft:"auto"}}>
            <Link to="/category/1" style={{textDecoration: "none", color: "white"}}><Tab label="SAMSUNG" /></Link>
            <Link to="/category/2" style={{textDecoration: "none", color: "white"}}><Tab label="APPLE" /></Link>
            <Link to="/category/3" style={{textDecoration: "none", color: "white"}}><Tab label="GARMIN" /></Link>
          </Tabs>
